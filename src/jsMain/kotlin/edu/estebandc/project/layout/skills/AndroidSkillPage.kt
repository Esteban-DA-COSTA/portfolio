    ...
    return div {
        ...
        section("La mise en pratique d'Android dans mon cursus") {
            ...
            card("Les notifications") {
                p("Un concept clé d'Andoid sont les notifications push. Ce sont des messages qu'une application peut envoyer au système que ce dernier affiche à l'utilisateur directement sur la page d'accueil ou la page de verrouillage.")
        ...
        section("Mon niveau") {
            card("Ma maitrise") {
                ...
                p("De plus, les deux projets ont été effectués avec le langage Java plutôt que Kotlin. Il faut savoir que Google recommande l'utilisation de Kotlin pour le développement Android. L'utilisation de Java dans mon cas montre une connaissance succinte du système.")
            }
            card("Ma marge de progression") {
                p("Dans l'avenir, j'espère améliorer mes connaissance en Android grâce à des projets Kotlin. J'ai en effet appris ce langage de façon autodidacte, et son application en Android serait un bon moyen de m'améliorer dans les deux domaines.")
                p("Il existe un framework Kotlin appellé Jetpack, reconnu et soutenu par Google, permettant de développer des applications Android plus fiables et plus maintenables. Il s'agit ici de la marge de progression à moyen terme de ma maitrise d'Android")
            }
            card("Mon appréciation") {
